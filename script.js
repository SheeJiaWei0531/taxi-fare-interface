let taxiFareApiUrl = 'https://jw-oc47rw55ea-ew.a.run.app/predict'; // replace with your API endpoint
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      .then(data => {
        ...
        const fare_amount = Math.round(data['fare_amount'] * 100) / 100
        fareResult.innerText = `$${fare_amount}`;
      })
      .catch((error) => {
